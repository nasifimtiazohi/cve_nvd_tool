...
def create_tables(myuser,mypassword,myhost,database):
    try:
        ...
        create_tables_query = open('schema.sql','r').read()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-u', '--user',  action="store", dest="user", default="", help="The user to connect to the database.")
    ...
    parser.add_argument('-db', '--database',  action="store", dest="database", default="nvdcve", help="The name of the database.")
